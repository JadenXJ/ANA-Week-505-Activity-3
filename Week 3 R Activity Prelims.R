...
#Such as number of columns, number of observations, what the variables are, and some of the corresponding observations.
...
#Such as Min, Q1, Med, Q3, Max and Mean
#Task: Complete the comment above
summary(Jaden_mydata)
...
Heightandweight2 <- subset(HeightandWeight, Just_Height>65)
...
#The difference between the two would be obviously the number of columns. NewWomen includes the HeightandWeight dataset with the Just_weight and Just_Height
...
ggplot(NewWomen, aes(x=height, y=weight)) + 
  geom_point(shape = 22, colour = "black", fill = "Yellow", size = 6, stroke = 3)
